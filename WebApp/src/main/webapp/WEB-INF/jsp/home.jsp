            	...
            	<div class="container" >
                    <table class="table table-dark table-striped text-light">
                        ...
                        <tbody>
							...
							<tr><td><span><a href="groupdetailpage?groupName=${grp}">${grp}</a></span></td><td><a class="group-mngmnt-btns" name="searchgroups" id="btn-create-group" href="editgroupusers">Edit Users</a></td></tr>
							</c:forEach>
							</tr>
                        </tbody>
                    </table>
