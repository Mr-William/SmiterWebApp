  ...
  <body ng-app="SmiterApp" ng-controller="MusicController as ctrl">
    ...
    <section id="is95" class="flex-sect">
      <div id="ig5f" class="gjs-row">
        ...
        <form ng-submit="ctrl.createMusic()" name="musicForm"
            ...
            <div class="form-group col-md 12">
              ...
              <div class="col-md-7">
                <input type="text" ng-model="ctrl.music.artist"
                  id="artist" class="from-control input-sm"
          ...
          <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <input type="text" ng-model="ctrl.music.albumTitle" placeholder="Optional - Album" id="music_albumTitle"/>
                </div>
            </div>
        </div>
        <div class="row">
          ...
          <div class="gjs-row">
            <div class="form-actions floatRight">
              <input type="submit" value="Add Music" class="btn btn-primary btn-sm">
